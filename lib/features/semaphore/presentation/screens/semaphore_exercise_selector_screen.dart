...
class SemaphoreExerciseSelectorScreen extends ConsumerStatefulWidget {
  const SemaphoreExerciseSelectorScreen({super.key});

  @override
  ConsumerState<SemaphoreExerciseSelectorScreen> createState() =>
      _SemaphoreExerciseSelectorScreenState();
}

class _SemaphoreExerciseSelectorScreenState
    extends ConsumerState<SemaphoreExerciseSelectorScreen> {
  ...
  TranslationDirection get _direction => _directionIndex == 0
  ...
  Future<void> _start() async {
    await ref.read(semaphoreExerciseProvider.notifier).startExercise(
          _direction,
          _interactionType,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.sm),
            FilterChipRow(
              options: const ['Swipe', 'Tipkovnica', 'Žetoni'],
