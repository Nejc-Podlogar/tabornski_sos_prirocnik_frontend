...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(selectedTopoCategory) =>
      "${Intl.select(selectedTopoCategory, {'geodetske_tocke': 'Geodetic points', 'morje_in_morska_obala': 'The sea and the sea coast', 'naselja_in_objekti': 'Settlements and facilities', 'promet': 'Traffic', 'rastje_in_vrste_tal': 'Growth and soil types', 'relief': 'Relief', 'vodovje': 'Water supply', 'meje_in_ograje': 'Borders and fences', 'other': 'Other'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "endOfExercise": MessageLookupByLibrary.simpleMessage("End of exercise"),
    ...
    "sizeOfQuestion": MessageLookupByLibrary.simpleMessage(
      "Size of the question",
    ),
    "specialCharacters": MessageLookupByLibrary.simpleMessage(
      "Special characters",
    ),
    "startTransmitting": MessageLookupByLibrary.simpleMessage(
      "Start transmitting",
    ),
    ...
    "translatedText": MessageLookupByLibrary.simpleMessage("Translated text"),
